...
10.times do
    User.create(username: Faker::Internet.username, user_type: "Rapper", age: rand(18..100), bio: "Lorem Ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...", password: Faker::Internet.password)
end

10.times do
    User.create(username: Faker::Internet.username, user_type: "Producer", age: rand(18..100), bio: "Lorem Ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...", password: Faker::Internet.password)
end
...
Match.create(rapper_id: 1, producer_id: 11)
